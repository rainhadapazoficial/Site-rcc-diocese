                                    ...
                                    <div className="space-y-10">
                                        ...
                                        <div className="pt-8 flex gap-6">
                                            {selectedGroup.whatsapp && (
                                                <a href={selectedGroup.whatsapp} target="_blank" rel="noopener noreferrer" className="p-6 bg-green-50 text-green-600 rounded-2xl hover:bg-green-600 hover:text-white transition-all transform hover:scale-110 shadow-sm border border-green-100/50">
                                                    <MessageCircle className="w-8 h-8 fill-current" />
                                                </a>
                                            )}
                                            {selectedGroup.instagram && (
                                                <a href={selectedGroup.instagram} target="_blank" rel="noopener noreferrer" className="p-6 bg-pink-50 text-pink-600 rounded-2xl hover:bg-pink-600 hover:text-white transition-all transform hover:scale-110 shadow-sm border border-pink-100/50">
                                                    <Instagram className="w-8 h-8" />
                                                </a>
                                            )}
                                            {selectedGroup.facebook && (
                                                <a href={selectedGroup.facebook} target="_blank" rel="noopener noreferrer" className="p-6 bg-blue-50 text-blue-600 rounded-2xl hover:bg-blue-600 hover:text-white transition-all transform hover:scale-110 shadow-sm border border-blue-100/50">
                                                    <Facebook className="w-8 h-8" />
                                                </a>
                                            )}
                                            {selectedGroup.site && (
                                                <a href={selectedGroup.site} target="_blank" rel="noopener noreferrer" className="p-6 bg-brand-blue/5 text-brand-blue rounded-2xl hover:bg-brand-blue hover:text-white transition-all transform hover:scale-110 shadow-sm border border-brand-blue/10">
